...
/// @notice Derived from swap-vm v1.0.2 `src/opcodes/AquaOpcodes.sol` (© 2025 Degensoft Ltd), extended with ForexCurve.
...
import { ForexCurve } from "../instructions/ForexCurve.sol";

/// @title AquaForexOpcodes
/// @notice Aqua instruction set for forex strategies: v1.0.2 `AquaOpcodes` indices preserved, ForexCurve (the Shell v1 / DFX
///         forex curve) appended at 34. Same table as AquaFXOpcodes with ForexCurve in FXSwap's slot.
...
contract AquaForexOpcodes is Controls, XYCSwap, Fee, PeggedSwap, Extruction, ForexCurve {
