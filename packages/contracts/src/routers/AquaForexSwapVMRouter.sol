...
import { AquaForexOpcodes } from "../opcodes/AquaForexOpcodes.sol";

/// @title AquaForexSwapVMRouter
/// @notice Aqua SwapVM router whose instruction set adds ForexCurve (index 34, the Shell v1 / DFX forex curve) to the
///         AquaOpcodes indices it keeps.
/// @dev Deploy with EIP-712 name `AquaSwapVMRouter` so Aqua0's AquaAdapter accepts it, e.g. version `1.0.2-forex`.
contract AquaForexSwapVMRouter is Simulator, SwapVM, AquaForexOpcodes {
